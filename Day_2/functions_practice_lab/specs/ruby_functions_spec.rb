...
#Further
  ...
  def test_volume_of_cube()
      cube_result = volume_of_a_cube(2)
      assert_equal(8, cube_result)
  end

  # #Given the radius of a sphere calculate the volume
  def test_volume_of_sphere()
    sphere_result = volume_of_a_sphere(2)
    assert_equal(33.51, sphere_result)
  end

  # #You can add your own converters
  def test_fahrenheit_to_celsius()
    celcius_result = fahrenheit_to_celcius(100)
    assert_equal(37.8, celcius_result)

  end

  def test_password_generator()
    password_generated = password_generator("Password", 123)
    assert_equal("pASSWORD246", password_generated)
  end
